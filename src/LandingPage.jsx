        ...
        <div className="dark:text-white md:px-20 px-5 py-7">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-10 ">
                    {/* links  */}
                    <div className="space-x-10 max-lg:hidden font-sans font-semibold">
                        <Link to="/">Home</Link>
                    ...
                    <div>
                        ...
                        <button class="px-6 py-3 rounded-lg font-semibold text-white 
                                    bg-blue-600
                                    hover:opacity-90 transition-all duration-300 font-sans shadow-lg">Sign Up</button>
                                    </Link>
                    </div>
                </div>
            ...
            <header className="my-20 grid lg:grid-cols-2 gap-10">
                ...
                <div className="space-y-6">
                    <h1 className="lg:text-6xl text-6xl font-sans font-bold max-lg:text-center">Create. Edit. <br className="max-lg:hidden"/>Grow, With Clipfy</h1>
                    ...
                    <div className="lg:space-x-5 space-y-5 max-lg:flex max-lg:flex-col">
